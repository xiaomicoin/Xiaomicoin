...
int64 nChainStartTime = 1404442800;
...
const string strMessageMagic = "Xiaomicoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Xiaomicoin
    bool fStrictPayToScriptHash = true; // Always active in Xiaomicoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Xiaomicoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "4/7/2014, Bitcoin, Height:309113, BlockHash:000...e10e764fba407c8ea4f5c6ed12f";
        CTransaction txNew;
        ...
        block.nNonce   = !fTestNet ? 26730 : 4365;
        ...
        assert(block.hashMerkleRoot == uint256("0x3fcd7545c53af60a0d0916309ffd1616c4701829e5834ed2be04df9492ccef71"));
